...
func TestCanConstruct(t *testing.T) {
	...
	tests := []struct {
		...
		{"example1", args{"a", "b"}, false},
		{"example2", args{"aa", "ab"}, false},
		{"example3", args{"aa", "aab"}, true},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestFourSum(t *testing.T) {
	...
	tests := []struct {
		...
		{"example1", args{[]int{1, 0, -1, 0, -2, 2}, 0}, [][]int{{-2, -1, 1, 2}, {-2, 0, 0, 2}, {-1, 0, 0, 1}}},
		{"example2", args{[]int{2, 2, 2, 2, 2}, 8}, [][]int{{2, 2, 2, 2}}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_wordPattern(t *testing.T) {
	...
	tests := []struct {
		...
		{"test1", args{"abba", "dog cat cat dog"}, true},
		{"test2", args{"abba", "dog cat cat fish"}, false},
		{"test3", args{"aaaa", "dog cat cat dog"}, false},
		{"test4", args{"abba", "dog dog dog dog"}, false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_groupAnagrams(t *testing.T) {
	...
	tests := []struct {
		...
		{"test1", args{[]string{"eat", "tea", "tan", "ate", "nat", "bat"}}, [][]string{{"bat"}, {"nat", "tan"}, {"ate", "eat", "tea"}}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_containsNearbyDuplicate(t *testing.T) {
	...
	tests := []struct {
		...
		{"test1", args{[]int{1, 2, 3, 1}, 3}, true},
		{"test2", args{[]int{1, 0, 1, 1}, 1}, true},
		{"test3", args{[]int{1, 2, 3, 1, 2, 3}, 2}, false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_longestConsecutive(t *testing.T) {
	...
	tests := []struct {
		...
		{"test2", args{[]int{0, 3, 7, 2, 5, 8, 4, 6, 0, 1}}, 9},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
